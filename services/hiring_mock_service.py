    ...
    def generate_agent_response(
        ...
        if phase == 'screen':
            return (
                ...
                "최종 검토 대상 5명입니다. (상세 스펙은 화면 상단 지원자 명단을 참고하세요)\n"
                ...
                "- 지원자 E 정하윤: 실행력·멀티태스킹 강점, 전문 분야 깊이는 얕음.\n\n"
        ...
        if phase == 'finalize':
            body = (
                "후보 비교 분석기를 실행했습니다. 최종 후보 5명을 강점·우려·제 평가의 한계와 함께 정리했습니다.\n\n"
                ...
                "E) 정하윤 — 실행력·멀티태스킹. 강점: 빠른 실행, 넓은 범위. 우려: 전문성 깊이 얕음. 한계: 깊이는 짧은 검토로 판단 한계."
            )
            if is_auto:
