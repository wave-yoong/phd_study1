...
class GPTService:
    ...
    **출처 표기 규칙**:
    1. 출처명, 저자/기관, 문서 제목, 발행 날짜를 구체적으로 명시
    2. 사용자가 검색할 수 있도록 충분한 정보 제공
    ...
    2. 각 주요 내용 뒤에 출처 표기 (URL 없이)
    3. 답변 마지막에 "참고 자료" 섹션:
       "참고 자료:
       1. 김철수 외(2023) - 올리브유의 건강 효과 연구, 한국영양학회지, 56(2)
       2. 식품의약품안전처 - 식용유 안전관리 가이드, 2023
